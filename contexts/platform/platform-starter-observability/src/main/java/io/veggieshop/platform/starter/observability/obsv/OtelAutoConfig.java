...
@ConditionalOnProperty(prefix="veggieshop.otel", name="enabled", havingValue="true", matchIfMissing=true)
public class OtelAutoConfig {
    ...
    public Resource otelResource(Environment env, Optional<BuildProperties> build) {
        ...
        String environment = env.getProperty("SPRING_PROFILES_ACTIVE",
        ...
        Attributes attrs = Attributes.builder()
                ...
                .put(SERVICE_NAMESPACE_KEY, "veggieshop")          // بدلاً من SERVICE_NAMESPACE
                .put(SERVICE_VERSION, version)
                .put(DEPLOYMENT_ENVIRONMENT_KEY, environment)      // بدلاً من DeploymentAttributes.DEPLOYMENT_ENVIRONMENT
                .build();
    ...
    public ContextPropagators otelPropagators(OtelProperties props) {
        ...
        TextMapPropagator baggage = new FilteredBaggagePropagator(
    ...
    public OpenTelemetry openTelemetry(
        ...
        // ---- Logs ----
        BatchLogRecordProcessor logProcessor = BatchLogRecordProcessor.builder(
                        props.getProtocol().isGrpc()
    ...
    static final class FilteredBaggagePropagator implements TextMapPropagator {
        ...
        FilteredBaggagePropagator(TextMapPropagator delegate, Collection<String> allowedKeys) {
            ...
            this.allowedKeysLower = allowedKeys == null ? Set.of() :
                    allowedKeys.stream()
