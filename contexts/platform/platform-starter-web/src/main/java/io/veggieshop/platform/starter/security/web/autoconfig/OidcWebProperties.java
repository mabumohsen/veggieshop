...
public class OidcWebProperties {
  ...
  @NotNull private List<String> allowedAlgs = new ArrayList<>(List.of("RS256"));

  /** Expected audience claims; empty = skip audience check in filter. */
  @NotNull private Set<String> audience = new LinkedHashSet<>();
  ...
  @NotNull private Duration clockSkew = Duration.ofMinutes(2);

  /** JWKS connect timeout. */
  @NotNull private Duration jwksConnectTimeout = Duration.ofSeconds(2);

  /** JWKS read timeout. */
  @NotNull private Duration jwksReadTimeout = Duration.ofSeconds(3);
  ...
  public List<String> getAllowedAlgs() {
    return Collections.unmodifiableList(allowedAlgs);
  }
  ...
  public void setJwksReadTimeout(Duration jwksReadTimeout) {
    this.jwksReadTimeout = jwksReadTimeout;
  }

  public int getJwksSizeLimitBytes() {
    return jwksSizeLimitBytes;
  }

  public void setJwksSizeLimitBytes(int jwksSizeLimitBytes) {
    this.jwksSizeLimitBytes = jwksSizeLimitBytes;
  }
