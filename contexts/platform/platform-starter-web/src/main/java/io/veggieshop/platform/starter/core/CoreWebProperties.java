...
public class CoreWebProperties {
    ...
    public boolean isForwardedEnabled() { return forwardedEnabled; }
    public void setForwardedEnabled(boolean forwardedEnabled) { this.forwardedEnabled = forwardedEnabled; }
}
