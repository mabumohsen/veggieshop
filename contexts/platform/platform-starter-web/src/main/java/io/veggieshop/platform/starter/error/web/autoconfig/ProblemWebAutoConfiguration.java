...
/**
 * Auto-config for Problem+JSON (RFC7807) wiring.
 * - Provides ProblemFactory & ProblemHttpMapper if missing.
 * - Registers ProblemExceptionAdvice without relying on component-scan.
 */
@AutoConfiguration
@ConditionalOnWebApplication(type = ConditionalOnWebApplication.Type.SERVLET)
@ConditionalOnClass(DispatcherServlet.class)
@ConditionalOnProperty(prefix = "veggieshop.web.problem", name = "enabled", havingValue = "true", matchIfMissing = true)
