...
public class StepUpWebProperties {
    ...
    @NotNull
    private Set<String> mfaAmrHints = new LinkedHashSet<>(Set.of("mfa","otp","totp","webauthn","hwk","sms"));
    ...
    public Duration getDefaultMaxAge() { return defaultMaxAge; }
    public void setDefaultMaxAge(Duration defaultMaxAge) { this.defaultMaxAge = defaultMaxAge; }

    public Set<String> getMfaAmrHints() { return mfaAmrHints; }
    public void setMfaAmrHints(Set<String> mfaAmrHints) {
        this.mfaAmrHints = (mfaAmrHints == null) ? new LinkedHashSet<>() : new LinkedHashSet<>(mfaAmrHints);
    }

    public boolean isAllowHmacPrincipals() { return allowHmacPrincipals; }
    public void setAllowHmacPrincipals(boolean allowHmacPrincipals) { this.allowHmacPrincipals = allowHmacPrincipals; }
