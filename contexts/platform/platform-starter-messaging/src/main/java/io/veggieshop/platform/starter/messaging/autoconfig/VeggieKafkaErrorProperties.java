...
public class VeggieKafkaErrorProperties {
    ...
    public String getQuarantineSuffix() { return quarantineSuffix; }
    public void setQuarantineSuffix(String quarantineSuffix) { this.quarantineSuffix = quarantineSuffix; }
