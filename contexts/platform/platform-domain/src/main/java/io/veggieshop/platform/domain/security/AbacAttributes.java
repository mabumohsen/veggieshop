 ...
 * AbacAttributes
 *
 * <p>Enterprise-grade, framework-agnostic attribute container for Attribute-Based Access Control
 * (ABAC). Lives in the <em>domain</em> module (no Spring/Servlet/Kafka deps) and is consumed by the
 * {@code AbacPolicyEngine} in the application layer.
 *
 * <h2>Design goals (aligned with PRD v2.0)</h2>
 *
 * <ul>
 *   <li><b>Multi-tenancy first:</b> attributes capture tenant alignment and vendor ownership to
 *       enforce “tenant match”.
 *   <li><b>Defense-in-depth:</b> risk signals include data sensitivity (PII/PCI/PHI), action
 *       criticality, MFA state, just-in-time elevation, and two-person approval counts.
 *   <li><b>Immutability:</b> instances are immutable and safely shareable across virtual threads.
 *   <li><b>OPA-friendly:</b> {@link #toDecisionInput()} returns a primitive map for policy engines.
 *   <li><b>No PII leakage:</b> fields are identifiers/booleans/categories only—no raw PII values.
 * </ul>
 *
 * <h3>Typical usage</h3>
 *
...
public final class AbacAttributes {
  ...
  private AbacAttributes(Builder b) {
    ...
    this.environment =
        Objects.requireNonNullElseGet(b.environment, () -> Environment.builder().build());
  ...
  /**
   * Compute an <em>effective</em> risk level combining action, data sensitivity, classes
   * (PII/PCI/PHI), and environmental modifiers. This is a heuristic to help the policy engine, not
   * a hard rule.
   */
  public RiskLevel effectiveRiskLevel() {
    RiskLevel base =
        RiskLevel.max(
            action.baseRisk(), riskFor(resource.sensitivity()), riskFor(resource.dataClasses()));
  ...
  private static RiskLevel riskFor(Set<DataClass> classes) {
    ...
    if (classes.contains(DataClass.PCI)) {
      return RiskLevel.CRITICAL;
    }
    if (classes.contains(DataClass.PHI) || classes.contains(DataClass.PII)) {
  ...
  public Map<String, Object> toDecisionInput() {
    return Map.of(
        ...
        Map.of(
            "requestTime",
            Optional.ofNullable(environment.requestTime()).map(Instant::toString).orElse(null),
            "ipAddress",
            ...
            environment.traceId(),
            "approvalsCount",
            environment.approvalsCount(),
            "automated",
            environment.automated()),
        "effectiveRisk",
        effectiveRiskLevel().name(),
        "extensions",
        extensions);
  }
   ...
   *
   * @param actorTenantId the actor's tenant id
   * @param resourceTenantId the resource's tenant id
   * @param actionName dotted action name (e.g. {@code inventory.adjust})
   */
  public static Builder builder(
      TenantId actorTenantId, TenantId resourceTenantId, String actionName) {
    return new Builder(actorTenantId, resourceTenantId, actionName);
  }

  /**
   * Overload accepting {@link CharSequence} for action name.
   *
   * @see #builder(TenantId, TenantId, String)
   */
  public static Builder builder(
      TenantId actorTenantId, TenantId resourceTenantId, CharSequence actionName) {
    return builder(actorTenantId, resourceTenantId, String.valueOf(actionName));
  }

  // ========= Builder =========

  /** Builder for {@link AbacAttributes}. */
  public static final class Builder {
    ...
    /** Sets extra non-PII flags; copied defensively. */
    public Builder extensions(Map<String, Object> extensions) {
      this.extensions = (extensions == null) ? null : Map.copyOf(extensions);
      return this;
    }
  ...
  /**
   * Actor (subject) attributes. Keep values coarse-grained—no PII. {@code vendorId} is a stable
  ...
  public static final class Actor {
    ...
    private Actor(Builder b) {
      ...
      this.roles =
          Collections.unmodifiableSet(
              Objects.requireNonNullElse(b.roles, EnumSet.noneOf(Roles.class)));
    ...
    public AuthnStrength authnStrength() {
      return authnStrength;
    }

    public boolean stepUpMfaSatisfied() {
      return stepUpMfaSatisfied;
    }

    public boolean justInTimeElevation() {
      return justInTimeElevation;
    }
    ...
    public static final class Builder {
      ...
      public Builder scopes(Set<String> scopes) {
        this.scopes = (scopes == null) ? null : Set.copyOf(scopes);
        return this;
      }

      public Builder authnStrength(AuthnStrength authnStrength) {
        this.authnStrength = authnStrength;
        return this;
      }

      public Builder stepUpMfaSatisfied(boolean v) {
        this.stepUpMfaSatisfied = v;
        return this;
      }

      public Builder justInTimeElevation(boolean v) {
        this.justInTimeElevation = v;
        return this;
      }
  ...
  /** Resource attributes. Only identifiers and categories—no descriptive PII payloads. */
  public static final class Resource {
    ...
    private Resource(Builder b) {
      ...
      this.dataClasses =
          Collections.unmodifiableSet(
              Objects.requireNonNullElse(b.dataClasses, EnumSet.noneOf(DataClass.class)));
    }
    ...
    public Optional<String> ownerVendorId() {
      return Optional.ofNullable(ownerVendorId);
    }
    ...
    public Set<DataClass> dataClasses() {
      return dataClasses;
    }
    ...
    public static final class Builder {
      ...
      public Builder ownerVendorId(String ownerVendorId) {
        this.ownerVendorId = ownerVendorId;
        return this;
      }

      public Builder sensitivity(DataSensitivity sensitivity) {
        this.sensitivity = sensitivity;
        return this;
      }

      /** Defensive copy to avoid external mutation. */
      public Builder dataClasses(Set<DataClass> dataClasses) {
        if (dataClasses == null) {
          this.dataClasses = null;
        } else if (dataClasses.isEmpty()) {
          this.dataClasses = EnumSet.noneOf(DataClass.class);
        } else {
          this.dataClasses = EnumSet.copyOf(dataClasses);
        }
        return this;
      }
  ...
  /**
   * Action semantics for the attempted operation. {@code name} follows a dotted convention: e.g.,
   * {@code "catalog.write"}, {@code "checkout.placeOrder"}.
   */
  public static final class Action {
    ...
    public boolean requiresStepUpMfa() {
      return requiresStepUpMfa;
    }

    public boolean requiresTwoPersonApproval() {
      return requiresTwoPersonApproval;
    }
    ...
    public static final class Builder {
      ...
      public Builder baseRisk(RiskLevel baseRisk) {
        this.baseRisk = baseRisk;
        return this;
      }

      public Builder requiresStepUpMfa(boolean v) {
        this.requiresStepUpMfa = v;
        return this;
      }

      public Builder requiresTwoPersonApproval(boolean v) {
        this.requiresTwoPersonApproval = v;
        return this;
      }
  ...
  /** Request environment (coarse metadata only). Keep it safe for logs and policy evaluation. */
  public static final class Environment {
    ...
    public static final class Builder {
      ...
      public Builder approvalsCount(int approvalsCount) {
