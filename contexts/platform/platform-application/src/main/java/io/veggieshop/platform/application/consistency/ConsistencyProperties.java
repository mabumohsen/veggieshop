 ...
 *
 * Immutable configuration for the consistency subsystem (token TTL, RYW wait tuning, clock skew).
 */
public final class ConsistencyProperties {
    ...
    public Duration rywMaxWait()     { return rywMaxWait; }
    public Duration rywInitialPoll() { return rywInitialPoll; }
    public Duration rywMaxPoll()     { return rywMaxPoll; }
    ...
    public static final class Builder {
        ...
        public Builder tokenTtl(Duration v)       { this.tokenTtl = v; return this; }
        public Builder clockSkew(Duration v)      { this.clockSkew = v; return this; }
        public Builder rywMaxWait(Duration v)     { this.rywMaxWait = v; return this; }
        public Builder rywInitialPoll(Duration v) { this.rywInitialPoll = v; return this; }
        public Builder rywMaxPoll(Duration v)     { this.rywMaxPoll = v; return this; }

        public ConsistencyProperties build()      { return new ConsistencyProperties(this); }
    }

    @Override public String toString() {
        return "ConsistencyProperties{tokenTtl=" + tokenTtl +
                ", clockSkew=" + clockSkew +
                ", rywMaxWait=" + rywMaxWait +
                ", rywInitialPoll=" + rywInitialPoll +
                ", rywMaxPoll=" + rywMaxPoll + "}";
    }
}
