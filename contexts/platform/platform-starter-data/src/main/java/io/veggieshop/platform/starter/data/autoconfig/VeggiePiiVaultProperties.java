...
/**
 * Properties:
 * veggieshop.pii.vault.active-kid: k1
 * veggieshop.pii.vault.master-keys.k1: "Base64(32 bytes)"
 * veggieshop.pii.vault.default-ttl: 365d
 * veggieshop.pii.vault.max-payload-bytes: 16384
 * veggieshop.pii.vault.salt-bytes: 16
 * veggieshop.pii.vault.iv-bytes: 12
...
public class VeggiePiiVaultProperties implements PiiVaultConfig {
    ...
    public void setMasterKeys(Map<String, String> masterKeys) { this.masterKeys = masterKeys; }

    @Override public @Nullable Duration getDefaultTtl() { return defaultTtl; }
    public void setDefaultTtl(@Nullable Duration defaultTtl) { this.defaultTtl = defaultTtl; }
    ...
    public void setSaltBytes(int saltBytes) { this.saltBytes = saltBytes; }
    ...
    public void setFailIfMissingKey(boolean failIfMissingKey) { this.failIfMissingKey = failIfMissingKey; }
